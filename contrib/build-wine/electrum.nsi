...
;Variables
  ...
  !define PRODUCT_WEB_SITE "https://github.com/dArkjON/electrum-btx"
  !define PRODUCT_PUBLISHER "Bitcore BTX"
...
;Interface Settings
  ...
  !define MUI_ICON "..\..\electrum\gui\icons\electrumBTX.ico"
...
Section
  ...
  File "..\..\electrum\gui\icons\electrumBTX.ico"
  ...
  WriteRegStr HKCU "Software\Classes\bitcore" "DefaultIcon" "$\"$INSTDIR\electrumBTX.ico, 0$\""
  ...
  WriteRegStr HKCU "Software\Classes\lightning" "DefaultIcon" "$\"$INSTDIR\electrumBTX.ico, 0$\""
  ...
  WriteRegStr HKCU "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\electrumBTX.ico"
